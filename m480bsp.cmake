	...
	set(M480BSP_PATH ${CMAKE_CURRENT_LIST_DIR}/Drivers)
	set(M480BSP_STDDRIVE_PATH ${M480BSP_PATH}/Library/StdDriver)
	set(M480BSP_HAL_PATH ${M480BSP_PATH}/HAL)
	set(M480BSP_CMSIS_PATH ${M480BSP_PATH}/CMSIS)


	target_sources(m480bsp INTERFACE
		${M480BSP_PATH}/Library/Device/Nuvoton_M480/Source/system_M480.c
		${CMAKE_SOURCE_DIR}/Device_Startup/startup_M480.S
	...
	target_include_directories(m480bsp INTERFACE
		${M480BSP_PATH}/Library/Device/Nuvoton_M480/Include
