...
/* Main and Proc_0 in the Ada version             */
{
    ...
    */
    ...
    if (User_Time < Too_Small_Time) {
        ...
        Microseconds =
            User_Time * Mic_secs_Per_Second / (double) Number_Of_Runs;
        ...
        //   fprintf(Ap, " Classic Benchmark Ratings for CPUSpeed.txt where 100
        //   MHz Pentium = 100\n");
        /*
        ...
        */
        ...
        if (Ptr_Glob->variant.var_1.Enum_Comp != 2) {
            fprintf(Ap,
                    " Wrong result Ptr_Glob->variant.var_1.Enum_Comp Was %d "
                    "Should be 2\n",
                    Ptr_Glob->variant.var_1.Enum_Comp);
            errors = errors + 1;
        }
        if (Ptr_Glob->variant.var_1.Int_Comp != 17) {
            fprintf(Ap,
                    " Wrong result Ptr_Glob->variant.var_1.Int_Comp Was %d "
                    "Should be 17\n",
        ...
        if (strcmp(Ptr_Glob->variant.var_1.Str_Comp,
                   "DHRYSTONE PROGRAM, SOME STRING") != 0) {
            fprintf(Ap,
                    " Wrong result Ptr_Glob->variant.var_1.Str_Comp Was %s "
        ...
        if (Next_Ptr_Glob->Discr != 0) {
            fprintf(Ap,
                    " Wrong result Next_Ptr_Glob->Discr Was %d Should be 0\n",
                    Next_Ptr_Glob->Discr);
            errors = errors + 1;
        }
        if (Next_Ptr_Glob->variant.var_1.Enum_Comp != 1) {
            fprintf(Ap,
                    " Wrong result Next_Ptr_Glob->variant.var_1.Enum_Comp Was "
                    "%d Should be 1\n",
                    Next_Ptr_Glob->variant.var_1.Enum_Comp);
            errors = errors + 1;
        }
        if (Next_Ptr_Glob->variant.var_1.Int_Comp != 18) {
            fprintf(Ap,
                    " Wrong result Next_Ptr_Glob->variant.var_1.Int_Comp Was "
                    "%d Should be 18\n",
        ...
        if (strcmp(Next_Ptr_Glob->variant.var_1.Str_Comp,
                   "DHRYSTONE PROGRAM, SOME STRING") != 0) {
            fprintf(Ap,
                    " Wrong result Next_Ptr_Glob->variant.var_1.Str_Comp Was "
                    "%s Should be DHRYSTONE PROGRAM, SOME STRING\n",
                    Next_Ptr_Glob->variant.var_1.Str_Comp);
            errors = errors + 1;
        }
        if (Int_1_Loc != 5) {
        ...
        if (strcmp(Str_1_Loc, "DHRYSTONE PROGRAM, 1'ST STRING") != 0) {
            fprintf(Ap,
                    " Wrong result Str_1_Loc Was %s Should be DHRYSTONE "
                    "PROGRAM, 1'ST STRING\n",
                    Str_1_Loc);
            errors = errors + 1;
        }
        if (strcmp(Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING") != 0) {
            fprintf(Ap,
                    " Wrong result Str_2_Loc Was %s Should be DHRYSTONE "
                    "PROGRAM, 2'ND STRING\n",
                    Str_2_Loc);
            errors = errors + 1;
        }
